...
namespace PPC.TrainingDevelopment.Api.Migrations
{
    ...
    [Migration("20251014140653_AddTrainingRecordEventEntity")]
    partial class AddTrainingRecordEventEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PPC.TrainingDevelopment.Api.Models.TrainingEvent", b =>
                {
                    ...
                    b.Property<string>("TrainingEventName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PPC.TrainingDevelopment.Api.Models.TrainingEvent", b =>
                {
                    b.HasOne("PPC.TrainingDevelopment.Api.Models.NonEmployee", "NonEmployee")
                        .WithMany()
